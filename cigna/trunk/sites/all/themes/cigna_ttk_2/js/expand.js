...
$.fn.expandAll = function(options) {
    ...
    return this.each(function(index) {
       ...
       (o.switchPosition == 'before') ? ($.fn.findSibling = $.fn.prev, $.fn.insrt = $.fn.before) : ($.fn.findSibling = $.fn.next, $.fn.insrt = $.fn.after);
        ...
        (o.oneSwitch) ? ($referent.insrt('<p class="switch"><a href="#" class="' + toggleClass + '" style="float:right; text-align: right; width: 100%; text-decoration: none; font-size: 13px; padding-right: 8px;">' + toggleTxt + '</a></p>')) :
