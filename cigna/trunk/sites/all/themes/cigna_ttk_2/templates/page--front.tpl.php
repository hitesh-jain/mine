          ...
          <div id="second-cat">
            <div class="r-img-wrapa"> <img src="<?php echo $base_url;?>/sites/all/themes/cigna_ttk_2/images/banner3.png" />
              <div class="topaddtext">
                ...
                <div class="optionpanel">
                  <ul>
                    <li><a href="<?php echo url('plans/indemnity-plans'); ?>"><span>Plans covering hospitalisation costs</span></a></li>
                    <li><a href="<?php echo url('plans/fixed-benefit-plans'); ?>"><span>Plans designed for specific needs</span></a></li>
                    <li><span><a href="<?php echo url('plans/indemnity-plans'); ?>">Show me all CignaTTK plans</a></span></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div class="topsection">
        <div class="topbolg">
          <section>
            ...
            <p><b>Quick Quote</b> is the fastest way to view and purchase a plan that suits your requirement. Enter a few basic details and get a no obligation quote – instantly.</p>
