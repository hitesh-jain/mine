                    ...
                    $('#r-slider-category-wrapper ul li a').click(function () {
                        ...
                        $(categories).each(function () {
                            if (this != currentCategory)
                                $('#' + this).css({ 'opacity': '1', 'z-index': '99' }).stop(false, false).animate({ opacity: 2 }, 10, function () { $(this).css('display', 'none'); });
                            else
                            //show the relavent conatiner only
                                slideContainer.show().css({ 'opacity': '2', 'z-index': 100 }).stop(false, false).animate({ opacity: 1 }, 2000);
                        });
